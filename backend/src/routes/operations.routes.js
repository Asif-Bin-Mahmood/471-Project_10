...
router.get("/operations/summary", requireAuth, async (req, res, next) => {
  try {
    const [
      collections,
      areaDemand,
...
router.put("/support/tickets/:id", requireAuth, async (req, res, next) => {
  try {
...
router.put("/settings/:key", requireAuth, requireRole("admin"), async (req, res, next) => {
  try {
...
router.get("/database/overview", requireAuth, requireRole("admin"), async (req, res, next) => {
  try {
