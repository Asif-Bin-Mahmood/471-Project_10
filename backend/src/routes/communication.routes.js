...
import { canAccessUser, requireAuth, requireSelfOrAdmin } from "../utils/auth.js";
...
router.get("/conversations/:userId", requireAuth, requireSelfOrAdmin("userId"), async (req, res, next) => {
  try {
...
router.get("/bookings/:userId", requireAuth, requireSelfOrAdmin("userId"), async (req, res, next) => {
  try {
...
router.put("/bookings/:id/respond", requireAuth, async (req, res, next) => {
  try {
...
router.get("/notifications/:userId", requireAuth, requireSelfOrAdmin("userId"), async (req, res, next) => {
  try {
