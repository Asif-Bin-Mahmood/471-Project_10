...
router.get("/admin/verifications", requireAuth, requireRole("admin"), async (req, res, next) => {
  try {
...
router.put("/admin/users/:id/verify", requireAuth, requireRole("admin"), async (req, res, next) => {
  try {
...
router.put("/admin/listings/:id/moderate", requireAuth, requireRole("admin"), async (req, res, next) => {
  try {
