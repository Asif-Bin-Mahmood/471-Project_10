...
const listings = await Listing.insertMany([
  ...
  {
    owner: users.property._id,
    title: "Uttara Corporate Suite",
    listingType: "property",
    category: "Office",
    area: "Uttara",
    address: "Sector 7, Uttara, Dhaka",
    location: { lat: 23.8759, lng: 90.3992 },
    price: 110000,
    size: 920,
    facilities: ["Lift", "Generator", "Parking", "Reception"],
    photos: ["office-floor.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.5,
    reviewCount: 11,
    description: "Bright corporate suite near Uttara's main commercial and transport connections."
  },
  {
    owner: users.property._id,
    title: "Mirpur Business Center",
    listingType: "property",
    category: "Office",
    area: "Mirpur",
    ...
    price: 68000,
    size: 760,
    facilities: ["Lift", "Security", "Generator", "Metro access"],
    photos: ["office-floor.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.4,
    reviewCount: 8,
    description: "Accessible office floor close to Mirpur Metro with practical team facilities."
  },
  {
    owner: users.property._id,
    title: "Motijheel Executive Floor",
    listingType: "property",
    category: "Office",
    area: "Motijheel",
    address: "Motijheel Commercial Area, Dhaka",
    location: { lat: 23.7337, lng: 90.4175 },
    price: 145000,
    size: 1280,
    facilities: ["Lift", "Generator", "Meeting room", "Banking district"],
    photos: ["office-floor.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.6,
    reviewCount: 15,
    description: "Executive commercial floor in Dhaka's established financial and corporate district."
  },
  {
    owner: users.property._id,
    title: "Dhanmondi Creative Studio",
    listingType: "property",
    category: "Office",
    area: "Dhanmondi",
    address: "Dhanmondi 27, Dhaka",
    ...
    price: 82000,
    size: 840,
    facilities: ["Natural light", "Lift", "Generator", "Road access"],
    photos: ["office-floor.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.5,
    reviewCount: 10,
    description: "Flexible studio-style workspace for creative teams, agencies and growing businesses."
  },
  {
    owner: users.property._id,
    title: "Tejgaon Commercial Showroom",
    listingType: "property",
    category: "Shop",
    area: "Tejgaon",
    address: "Tejgaon Industrial Area, Dhaka",
    location: { lat: 23.7638, lng: 90.3997 },
    price: 98000,
    size: 980,
    facilities: ["Wide frontage", "Loading access", "Parking", "Security"],
    photos: ["retail-front.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.3,
    reviewCount: 7,
    description: "Visible commercial showroom with convenient delivery and customer access."
  },
  {
    owner: users.service._id,
    title: "Bashundhara Office Renovation",
    listingType: "service",
    category: "Interior",
    area: "Bashundhara",
    coverageAreas: ["Bashundhara", "Badda", "Rampura", "Uttara"],
    address: "Bashundhara Residential Area, Dhaka",
    location: { lat: 23.8151, lng: 90.4255 },
    price: 58000,
    facilities: ["Space planning", "Civil work", "Furniture", "Project supervision"],
    photos: ["portfolio-1.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.7,
    reviewCount: 14,
    description: "Complete renovation and fit-out support for east and north Dhaka offices."
  },
  {
    owner: users.service._id,
    title: "West Dhaka Business Internet",
    listingType: "service",
    category: "ISP",
    area: "Mirpur",
    coverageAreas: ["Mirpur", "Mohammadpur", "Dhanmondi"],
    address: "Mirpur 10, Dhaka",
    location: { lat: 23.8069, lng: 90.3687 },
    price: 15000,
    facilities: ["Fiber planning", "Cabling", "Router setup", "Business support"],
    photos: ["isp-rack.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.7,
    reviewCount: 19,
    description: "Business-grade connectivity setup and support across west Dhaka commercial areas."
  },
  {
    owner: users.service._id,
    title: "Central Dhaka Electrical Care",
    listingType: "service",
    category: "Electrician",
    area: "Farmgate",
    coverageAreas: ["Farmgate", "Tejgaon", "Motijheel", "Paltan"],
    address: "Farmgate, Dhaka",
    location: { lat: 23.7579, lng: 90.3895 },
    price: 22000,
    facilities: ["Wiring audit", "Lighting", "DB installation", "Maintenance"],
    photos: ["electric-team.jpg"],
    status: "Available",
    verificationStatus: "verified",
    rating: 4.6,
    reviewCount: 16,
    description: "Commercial electrical installation and scheduled maintenance across central Dhaka."
  }
]);
